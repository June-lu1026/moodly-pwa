const CACHE='moodly-competition-v52';
const ASSETS=['./','./index.html','./style.css','./app.js','./manifest.webmanifest','./icons/logo-128.png','./icons/icon-192.png','./icons/icon-512.png'];
